...
- Playwright on Linux requires [additional dependencies](https://docs.cypress.io/guides/guides/launching-browsers#Linux-Dependencies) installed.

- Playwright on Debian 12 requires a minimum [Playwright 1.37](https://playwright.dev/docs/release-notes#-debian-12-bookworm-support) version.
...
npx cypress open --e2e --browser webkit
```
...
[Guides > Launching Browsers > WebKit (Experimental)](https://docs.cypress.io/guides/guides/launching-browsers#WebKit-Experimental)
